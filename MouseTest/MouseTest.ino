...
Bounce button3 = Bounce(LEFT, 10);  // if a button is too "sensitive"
Bounce button4 = Bounce(MIDDLE, 10);  // to rapid touch, you can
Bounce button5 = Bounce(RIGHT, 10);  // increase this time.
